...
type Props = { initialName?: string; onClose: () => void; onImported: (contact: Contact) => void; embedded?: boolean };

export default function WhatsAppImport({ initialName, onClose, onImported, embedded = false }: Props) {
