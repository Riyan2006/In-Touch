...
export type Contact = { contact_id: string; name: string; archetype: string; monthly_signals: Signal[]; detection: { baseline: Baseline; monthly_scores: Score[]; flag: Flag }; insight: string | null; data_source?: "whatsapp" | "calendar"; source_email?: string; month_labels?: string[] };
