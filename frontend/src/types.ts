...
export type Contact = { contact_id: string; name: string; archetype: string; monthly_signals: Signal[]; detection: { baseline: Baseline; monthly_scores: Score[]; flag: Flag }; insight: string | null };
